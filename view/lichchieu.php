            ...
            <div class="container_showtime_content active" data-tab="1">
                <div class="container_showtime_contentItem">
                    <div class="container_showtime_contentItemleft">
                        <div class="container_showtime_contentItemImg" style="background-image: url(assetsUser/img/15522894869902739-dffTM3qQ30xC0bJ7MUs2s3HrZ4e.jpg);"></div>
                    </div>
                    <div class="container_showtime_contentItemInfo">
                        <div class="container_showtime_contentItemInfo--category">
                            <p class="container_showtime_contentItemInfo--category1">Tâm lý, tình cảm</p>
                            <p class="container_showtime_contentItemInfo--categoryTime">128phút</p>
                        </div>
                        <p class="container_showtime_contentItemInfo--name"><strong>THE MARVEL</strong></p>
                        <p class="container_showtime_contentItemInfo--madin">Xuất xứ: Việt nam</p>
                        <p class="container_showtime_contentItemInfo--time">Khởi chiếu: 11-3-2023</p>
                        ...
                        <div class="container_showtime_contentItemInfo--showtimeInput">
                            <div class="container_showtime_contentItemInfo--showtimeInputList">11:30</div>
                            <div class="container_showtime_contentItemInfo--showtimeInputList">11:30</div>
                            <div class="container_showtime_contentItemInfo--showtimeInputList">11:30</div>
                            <div class="container_showtime_contentItemInfo--showtimeInputList">11:30</div>
                            <div class="container_showtime_contentItemInfo--showtimeInputList">11:30</div>

...
<head>
    ...
    <link rel="stylesheet" href="assetsUser/css/chung.css">
            ...
            <div class="header_nav">
                <div class="header_nav1">
                    <div class="header_nav1_top">
                        <a href="index.php?home"><img src="assetsUser/img/logo.png" alt="" class="header_nav_logo"></a>
                        <ul class="header_nav_menu">
                            ...
                            <li class="header_nav_menuList"><a href="index.php?act=giave"
                                    class="header_nav_menuList--link">THỂ LOẠI</a></li>
            ...
            <div class="slide">
                <div class="slideshow-container">
                    ...
                    <div class="mySlides fade">
                        <img src="assetsUser/img/0017061.webp" alt="" class="list_slide">
                    </div>

                    <div class="mySlides fade">
                        <img src="assetsUser/img/0017114.webp" alt="" class="list_slide">
                    </div>

                    <div class="mySlides fade">
                        <img src="assetsUser/img/0017121.webp" alt="" class="list_slide">
                    </div>
